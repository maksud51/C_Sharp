...
namespace Projeect
{
    public partial class RegistrationForm : Form
    {
        ...
        //Text Animation User Cotrol Start Here
        private void timer1_Tick(object sender, EventArgs e)
        {
           
            if(welcomTex.Right < 0)
            {
                welcomTex.Text = Convert.ToString(welcomTex.ClientSize.Width);
            }
            else
            {
                welcomTex.Left -= 10;
        ...
        private void welcomTex_TextChanged(object sender, EventArgs e)
        {
            welcomTex.AutoSize = true;
            welcomTex.Text = welcomTex.Text;
            welcomTex.Parent = welcomTex;
            welcomTex.Location = new Point(welcomTex.ClientSize.Width, welcomTex.ClientSize.Height / 2 - (welcomTex.Height / 2));
            
        }

        //Text Animation User Cotrol End Here
        ...
        private void signUp_Click(object sender, EventArgs e)
        {
            ...
            string querry_2 = "INSERT INTO DriverTb1(Name,UserName,Dob,Gender,PostalCode,Password,Number,Email,Image,licenseNumber,licenseIssueDate,vehicleType)VALUES('" + name.Text + "', '" + userName.Text + "', '" + dob.Value + "', '" + gender.Text + "', '" + pio.Text + "', '" + password.Text + "', '" + number.Text + "', '" + email.Text + "', '" + SPhoto() + "', '"+ licenseNumber.Text + "', '"+ licenseIssueDate.Value + "' '"+ vehicleType.SelectedItem + "' )";
        ...
        //Run Time Change Driver Panel
        private void userType_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (userType.SelectedItem.ToString() == "Sergent" || userType.SelectedItem.ToString() == "Civil-Person")
            {
                driverPanal.Visible = false;
            }
        ...
        private void userPictureButton_Click_1(object sender, EventArgs e)
        {
